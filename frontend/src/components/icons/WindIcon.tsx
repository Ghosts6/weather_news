...
const WindIcon: React.FC<IconProps> = ({ className, fill = 'currentColor' }) => (
  <svg viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className={className} fill={fill}>
    <g id="Page-1" stroke="none" strokeWidth="1" fillRule="evenodd" >
        <g id="Icon-Set" transform="translate(-465.000000, -776.000000)">
